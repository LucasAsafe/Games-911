...
public class SoundController : MonoBehaviour {
	...
	void Start () 
	{
		...
		//scoregettado = gameObject.GetComponent<GameController>().score;
		if (scoregettado == 4) 
		{
			instance.GetComponent<AudioSource>().PlayOneShot(instance.etetra);
		}
